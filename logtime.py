...
def usage():
    print "Usage:"
    print "     cat /path/to/file | ", sys.argv[0], "<grouping> <timepattern> <timespec>"
    print ""
    print "Example:"
    ...
    print "     %U  Week number of the year (Sunday as the first day of the week) as a decimal number [00,53]."
    print "     %w  Weekday as a decimal number [0(Sunday),6]"
    print "     %W  Week number of the year (Monday as the first day of the week) as a decimal number [00,53]."
    ...
    print "     Regex is Python regex re.findall() [https://docs.python.org/2/library/re.html]"
